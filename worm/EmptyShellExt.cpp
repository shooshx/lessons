...
#define GUID_STR L"{DC42E3E1-536D-4292-8D6D-C90123093B97}"
static const GUID CLSID_EmptyExt = { 0xdc42e3e1, 0x536d, 0x4292, { 0x8d, 0x6d, 0xc9, 0x1, 0x23, 0x9, 0x3b, 0x97 } };



#define EXT_NAME L"00WormShellExt"
...
#define DLL_EXP extern "C" HRESULT __stdcall 
...
DLL_EXP DllGetClassObject(REFCLSID rclsid, REFIID riid, LPVOID *ppReturn)
{
    *ppReturn = NULL;
    ...
    if( !IsEqualCLSID(rclsid, CLSID_EmptyExt) )
...
//    HKEY_CLASSES_ROOT, L"txtfile\\ShellEx\\ContextMenuHandlers\\" EXT_NAME,  NULL,   GUID_STR,
